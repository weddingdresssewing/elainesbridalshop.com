...
(function () {
  ...
  var ZH = {
    ...
    "hero.title": "您梦想中的婚纱,<br /><em>合身得恰到好处。</em>",
    "hero.sub": "一位专注于婚纱改制的私人裁缝师。收腰、放量、精修,一针一线,把您的婚纱改到完全贴合您的身形。献给不愿将就的新娘。",
    "hero.book": "预约试衣",
    "hero.gallery": "查看作品",

    /* strip */
    "strip.text": "萨克拉门托的新娘,把一生中最重要的那条裙子交给我们。我们收腰、放量、改下摆、重塑版型,直到您的名牌婚纱合身得仿佛<em>为您量身定制</em>——只为您一人。",

    /* about */
    "about.eyebrow": "裁缝师",
    "about.title": "完美合身,<br />是一门手艺。",
    "about.p1": "在萨克拉门托一家顶级婚纱店精修婚纱 11 年后,Elaine 想为新娘们打造更私人、一对一的体验。如今,她在自己的家庭工作室里,把超过 40 年的专业缝纫经验,直接倾注到您的婚纱上。",
    "about.p2": "她的事业,始于一张缝纫台、一把剪刀,和一个绝不妥协的信念——绝不让任何一位新娘穿上不真正合身的婚纱。Elaine 每季只接有限的新娘,因为一条能随您而动、稳稳贴合、上镜如梦的婚纱,急不得。从第一次试衣到最后熨烫,每一道针脚都由她亲手把关,您的婚纱始终不离她手。",
    "about.link": "开始您的试衣 <span>&rarr;</span>",

    /* services */
    "services.eyebrow": "我们做什么",
    "services.title": "完美合身,<br />陪您走过红毯。",
    "svc1.h": "精准改身",
    ...
    "process.lede": "从您发来第一条消息,到最后一次试衣,每一步我们都坦诚透明。以下就是我们合作的全过程。",
    "process.link": "索取报价 <span>&rarr;</span>",
    "p1.h": "时间与安排",
    "p1.p": "请先告诉我们您的婚礼日期。我们建议在<strong>婚礼前三到四个月</strong>开始改制——留足时间把婚纱做到完美,不必赶在最后一刻。",
    "p2.h": "试衣流程",
    ...
    "p3.h": "如何报价",
    "p3.p": "想要预估价格,请发来<strong>整条婚纱挂起来的照片</strong>——正面、背面和侧面——并附上您想做的具体改动清单。我们会根据照片给出预估报价,并在您第一次到店时确认最终价格。",
    "p4.h": "工作室位置",
    ...
    "contact.title": "让我们开始<br />您的婚纱之旅。",
    "contact.p": "我们采用私密的预约制。想最快拿到报价,请附上婚纱挂起来的照片(正面、背面和侧面),以及您想做的改动。我们会在两个工作日内回复您。",
    ...
    "opt.5": "还不确定",
    "lbl.photos": "照片(选填)",
    "photos.btn": "最多上传 3 张照片——您的婚纱(正面、背面、侧面)或心仪的款式",
    "btn.submit": "提交预约申请",
    ...
    "contact.success": "谢谢您——我们已收到您的预约申请,会尽快与您联系。♥",

    /* feedback */
    "fb.eyebrow": "意见反馈",
    "fb.title": "帮我们做得<br />更好。",
    "fb.lede": "和 Elaine 合作过吗?欢迎聊聊您的体验——一两句话,既能帮我们进步,也能帮到之后的新娘。",
    "fb.lblMsg": "您的反馈",
    "fb.lblName": "姓名(选填)",
    "fb.submit": "发送反馈",
  ...
  var META = {
    ...
    zh: {
      ...
      desc: "Elaine's Bridal Shop（爱莲婚纱坊）—— 位于加州萨克拉门托的家庭工作室,专精婚纱改制与定制裁缝。这里,有您梦想中的那条裙子。"
    }
  };
