...
(function () {
  ...
  var ZH = {
    ...
    "qs.h3": "预约私人试衣",
    "qs.p3": "准备好后,欢迎来到 Elaine 位于萨克拉门托 95828 的家庭工作室。私人试衣完全免费。",
    ...
    "p3.h": "发照片,预约免费咨询",
    "p3.p": "请把婚纱<strong>挂起来拍照</strong>发给我们,包含正面、背面和侧面,并说明您想改的地方。我们会据此为您安排<strong>免费咨询</strong>,届时提供预估报价,您再决定如何进行。",
    "p2.h": "试衣流程",
    ...
    "contact.textElaine": "<span>短信 Elaine</span><a href='sms:+14158139302'>(415) 813-9302</a>",
    ...
    "time.afternoon": "下午",
    "time.evening": "晚上",
    "lbl.referral": "您是怎么找到我们的?",
    "ref.default": "请选择…",
    "ref.friend": "朋友推荐",
    "more.summary": "补充你方便的时间和从哪知道我们 <span>(选填)</span>",
    "lbl.photos": "婚纱照片",
    "sms.btn": "<strong>把资料和照片短信发给 Chloe</strong><br />已帮您带上表单信息,附上照片即可(正面、背面、侧面)",
    "contact.textConsent": "可以通过短信联系我确认估价和预约。",
    "btn.submit": "提交试衣申请",
    "contact.hint": "想直接联系我们?短信 Chloe <a href='sms:+14157341832'>(415) 734-1832</a>,或发邮件至 <a href='mailto:weddingdresssewing@gmail.com'>weddingdresssewing@gmail.com</a>。",
    ...
    "price.cups": "加胸垫",
    "price.straps": "缩短肩带(一对)",
    "price.shoulders": "收肩(一对)",
    "price.side": "收腰身/侧缝",
    "price.zipper": "收拉链处",
    "price.hem": "改裙长",
    "price.cups2": "加胸垫",
    "price.straps2": "缩短肩带(一对)",
    "price.shoulders2": "收肩(一对)",
    "price.side2": "收腰身/侧缝",
    "price.zipper2": "收拉链处",
    "price.hem2": "改裙长",
  ...
  function apply(lang) {
    ...
    document.querySelectorAll('a[href*="dresses.elainesbridalshop"]').forEach(function (a) {
      try {
