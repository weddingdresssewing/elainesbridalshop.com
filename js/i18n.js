...
(function () {
  ...
  var ZH = {
    ...
    "cv.includes": "免费咨询包含:",
    "cv.i1": "<span>01</span>由你提供三围、身高体重,以及婚礼场地。",
    "cv.i2": "<span>02</span>我们为你推荐 <strong>30 款</strong>我们认为最适合你的婚纱。",
    "cv.i3": "<span>03</span>在婚纱做出来之前,先看到你穿上它的样子:免费为你制作一支效果预览视频。",
    "cv.i4": "<span>04</span>若你决定与我们定制婚纱,我们会为你量取详细尺寸,并收取报价 <strong>50% 的定金</strong>。婚纱到店后,我们会预约最后一次试衣,确保一切完美;若有不满意之处,我们会继续为你调整,直到你完全满意。",
