...
(function () {
  ...
  var ZH = {
    ...
    "cv.measureBtn": "量体指南",
    "paths.c1e": "定制婚纱",
    "paths.c1h": "一张照片,定制您的梦想婚纱。<em>$800 起。</em>",
    "paths.c1p": "免费咨询、免费效果预览视频,按您的尺寸量身制作。",
    "paths.c2e": "婚纱系列",
    "paths.c2h": "在线浏览 130+ 款婚纱。",
    "paths.c2p": "涵盖所有裙型,$400 起。先在线挑好心仪款式,剩下交给我们。",
    ...
    "contact.primaryLabel": "最快回复",
    "contact.primaryMain": "短信联系 Chloe · (415) 734-1832",
    "contact.studio": "<span>工作室</span>私人家庭工作室 · 加州萨克拉门托 95828 · 预约确认后提供详细地址",
    "contact.secondary": "<span>或</span>致电 Chloe (415) 734-1832 · Elaine (415) 813-9302 · <a href='mailto:weddingdresssewing@gmail.com'>发邮件</a>",
    "lbl.name": "姓名",
    "lbl.phone": "电话(便于短信回复)",
    "lbl.email": "邮箱(选填)",
    "lbl.date": "婚礼日期(选填)",
